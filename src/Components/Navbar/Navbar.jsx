...
const Navbar = () => {
  ...
  return (
    ...
    <li><AnchorLink className='anchor-link' offset={50} href='#work'><p onClick={()=>setMenu("work")}>PortFolio</p></AnchorLink>{menu==="work"? <img src={underline} height='20px' width='20px'/>:<></>}</li>
